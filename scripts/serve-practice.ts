...
let practiceState = createPracticeSeedState();
...
function snapshotPracticeState(): PracticeState {
  return {
...
function sendPracticeState(response: ServerResponse<IncomingMessage>): void {
  const state = snapshotPracticeState();
...
function resetPracticeState(): void {
  practiceState = createPracticeSeedState();
}
